...
<head>
  ...
  <title>BudgetTracker | Profile</title>
      ...
      <section class="content">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form autocomplete="off" method="post" action="profileEdit.php" role="form" enctype="multipart/form-data">
                <div class="box-body">
                    <label for="fullname">Full Name</label>
                    <input type="text" name="fullName" class="form-control" id="fullname" value="<?= $name ?>" placeholder="Enter your full name">
                    <label for="email">Email address</label>
                    <input name="email" type="email" class="form-control"  value="<?= $email ?>" placeholder="Enter email">

                    <label for="imageInput">your Image</label>
                    <input name="image" type="file" id="imageInput">
                    <label for="password">Edit your Password</label>
                    <input name="pass" type="password" class="form-control"   placeholder="Edit your Password">
                </div>
                  <input name="submit" type="submit" class="btn btn-block btn-primary btn-lg" value="Submit">
              </form>
